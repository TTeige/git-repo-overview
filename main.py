...
def handle_github(args):
    query_string = ""
    if args.github_user != "" or args.github_user is not None:
        query_string = "/users/" + args.github_user + "/repos"
    else:
        query_string = "/orgs/" + args.github_org + "/repos"

    resp = requests.get('https://api.github.com', auth=HTTPBasicAuth(args.g_user, args.g_pw))
